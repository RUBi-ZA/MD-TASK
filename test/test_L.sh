...
mv ${PREFIX}_0_L.dat ref_${PREFIX}_L.dat

python $BIN_DIR/calc_delta_L.py --generate-plots --normalize --normalization-mode ${NORM} --reference ref_${PREFIX}_L.dat --alternatives ${PREFIX}_*_L.dat
python $BIN_DIR/avg_network.py --data ${PREFIX}_*_L_${NORM}_delta_L.dat --data-type delta-L --prefix ${PREFIX} --generate-plots --x-label "Residues" --y-label "Avg delta L" --title "Wild Type"
...
python $BIN_DIR/calc_delta_L.py --generate-plots --normalize --normalization-mode ${NORM} --reference ref_${PREFIX}_L.dat --alternatives ${PREFIX}_*_L.dat
python $BIN_DIR/avg_network.py --data ${PREFIX}_*_L_${NORM}_delta_L.dat --data-type delta-L --prefix ${PREFIX} --generate-plots --x-label "Residues" --y-label "Avg delta L" --title "Mutant"
...
python $BIN_DIR/compare_networks.py --prefix "wt_mutant_L_avg" --reference-label Wild-type --alternative-label Mutant --y-label "Delta L" --reference ref_wt_L.dat --alternative mutant_delta_L_avg.dat
python $BIN_DIR/compare_networks.py --prefix "wt_mutant_L_std_dev" --reference-label Wild-type --alternative-label Mutant --y-label "Delta L" --reference ref_wt_L.dat --alternative mutant_delta_L_std_dev.dat
python $BIN_DIR/delta_networks.py --reference wt_delta_L_avg.dat --reference-std wt_delta_L_std_dev.dat --alternatives *delta_L_avg.dat --alternatives-std *delta_L_std_dev.dat --absolute --prefix wt_mutant_cmap --title "My Protein" --x-label "Residues" --y-label "Proteins"
