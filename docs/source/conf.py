# -*- coding: utf-8 -*-
#
# MD-TASK documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'md-task', u'MD-TASK Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MD-TASK', u'MD-TASK Documentation',
     author, 'MD-TASK', 'One line description of project.',
     'Miscellaneous'),
]
